...
## Points of Interest
Project will populate map with points of interest taken from a seperate file. Map will also drop a pin when clicked and tell the user what address that pin was dropped at. 
